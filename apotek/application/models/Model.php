...
class Model extends CI_Model {
	...
	public function Login($user,$pass) {
		$Query = $this->db->query("SELECT * FROM login_apotek WHERE username = '$user' AND password = '$pass' ");
		return $Query;	
	}

	public function CekRegister($user) {
		$Query = $this->db->query("SELECT * FROM user_apotek WHERE invitation_code = '$user'");
		return $Query;	
	}
