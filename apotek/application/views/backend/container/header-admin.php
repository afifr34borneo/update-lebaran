            ...
            <div class="navbar-collapse collapse" id="navbar">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown <?php if($link == 'Users'){ ?>active <?php } ?>">
                        <a aria-expanded="false" role="button" href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> Master Data <span class="caret"></span></a>
                        <ul role="menu" class="dropdown-menu">
                            <li><a href="<?=base_url()?>Administrator/apotek"> <i class="fa fa-flag"></i> &nbsp; Apotek</a></li>
                            <li><a href="<?=base_url()?>Administrator/add_pbf"><i class="fa fa-flag"></i> &nbsp; Pbf</a></li>
                            <li><a href="<?=base_url()?>Administrator/add_kurir"> <i class="fa fa-flag"></i> &nbsp; Kurir</a></li>
                        </ul>
                    </li>
