            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <h1 class="no-margins" align="right">100</h1>
                            <div class="stat-percent font-bold text-success"><small>PBF</small></div>
                ...
                <div class="col-md-3">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                                    <h1 class="no-margins" align="right">290</h1>
                                    <div class="stat-percent font-bold text-info"><small>Order</small></div>
                 ...
                 <div class="col-md-3">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                                    <h1 class="no-margins" align="right">15</h1>
                                    <div class="stat-percent font-bold text-danger"><small>Order</small></div>
                ...
                <div class="col-md-3">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                                    <h1 class="no-margins" align="right">275</h1>
                                    <div class="stat-percent font-bold text-warning"><small>Order</small></div>
