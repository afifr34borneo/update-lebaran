...
<h4><span style='color:#2b50a3'><strong>Paket Belum Dikirim</strong></span> <span style='color:#ff7f12'></span></h4>
...
<table class="table table-striped table-bordered table-hover dataTables-example">
                      ...
                      <?php $no = 0; foreach($paket as $vaData){ ?>
                          ...
                          <input type="hidden" name="cIdJadwal" id="cIdJadwal" value="<?php echo $this->session->userdata('idkirim') ?>">
                          <td><?php echo $vaData['tanggal_kirim'] ?></td>
                          <td><?php echo $vaData['jam_kirim'] ?></td>
                          <td><?php echo $vaData['zona'] ?></td>
    ...
    var cKirim          = $('input[name=cKirim]:checked').map(function(){
              ...
              $.ajax({
                  ...
                  data:"penumpang="+cPenumpang+
                       "&idjadwal="+cIdJadwal+
                       "&kirim="+cKirim,
                  url: "<?php echo site_url('Administrator_Act/input_sp_kirim/simpan')?>",
                  cache: false,
