...
<div id="form_container">
  ...
  <?php 
    $dataPbf = $this->model->code("SELECT * FROM pbf_v_order_sp WHERE status_notif = '".$bayar."' GROUP BY id_pbf");
    foreach ($dataPbf as $key => $vaData){ 
  ?>
	<h1 align="center">SURAT PENGIRIMAN ORDER PBF <?= strtoupper($vaData['namapbf'])?></h1>
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="0">
    <tr>
      ...
      <td align="right" width="20%">No SP :&nbsp;&nbsp;<b><?php echo $noSP?></b></td> 
    </tr>
  </table>
  <table width="100%" border="1" cellpadding="2" cellspacing="0">
    <tr style="background-color:#C0C0C0">
      ...
      <td align="center" width="8%">TTD</td>
    </tr>
    <?php 
    $no = 0;
    $dataPaket = $this->model->code("SELECT * FROM pbf_v_order_sp WHERE status_notif = '".$bayar."' AND id_pbf = '".$vaData['id_pbf']."' ORDER BY nama_apotek ASC ");
